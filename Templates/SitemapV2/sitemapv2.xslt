  ...
  <xsl:template match="/NavigationTree">
    ...
    <style type="text/css">
      #sitemap.M0 li a {
        ...
        font-color:<xsl:value-of select="//Setting[@Level=1]/NavigationFontColor/@Value" disable-output-escaping="yes"/>;
      ...
      #sitemap .M1 li a {
        ...
        font-color:<xsl:value-of select="//Setting[@Level=2]/NavigationFontColor/@Value" disable-output-escaping="yes"/>;
      ...
      #sitemap .M2 li a {
        ...
        font-color:<xsl:value-of select="//Setting[@Level=3]/NavigationFontColor/@Value" disable-output-escaping="yes"/>;
      ...
      #sitemap .M3 li a {
        ...
        font-color:<xsl:value-of select="//Setting[@Level=4]/NavigationFontColor/@Value" disable-output-escaping="yes"/>;
      ...
      #sitemap .M4 li a {
        ...
        font-color:<xsl:value-of select="//Setting[@Level=5]/NavigationFontColor/@Value" disable-output-escaping="yes"/>;
